...
class TestItemStockEndpoint:
    ...
    def test_get_stock_success(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "SKU001", "warehouse": "Stores - SD"}
        )
    ...
    def test_get_stock_zero_values(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "SKU_ZERO", "warehouse": "Stores - SD"}
        )
    ...
    def test_get_stock_negative_available(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "SKU_OVER", "warehouse": "Stores - SD"}
        )
    ...
    def test_get_stock_item_not_found(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "NONEXISTENT", "warehouse": "Stores - SD"}
        )
    ...
    def test_get_stock_erpnext_502_error(self, mock_client_class):
        ...
        mock_instance.__exit__ = MagicMock(return_value=None)
        mock_instance.get_value = MagicMock(
            side_effect=ERPNextClientError("Connection timeout")
        )
        mock_client_class.return_value = mock_instance
    ...
    def test_get_stock_empty_item_code(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "", "warehouse": "Stores - SD"}
        )
    ...
    def test_get_stock_empty_warehouse(self, mock_client_class):
        ...
        response = client.get(
            "/api/items/stock",
            params={"item_code": "SKU001", "warehouse": ""}
        )
        assert response.status_code == 400
        data = response.json()
    ...
    def test_get_stock_multiple_warehouses(self, mock_client_class):
        ...
        for warehouse in warehouses:
            response = client.get(
                "/api/items/stock",
                params={"item_code": "SKU001", "warehouse": warehouse}
            )
            assert response.status_code == 200
            data = response.json()
